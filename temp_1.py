...
for date in range(5, 16):  # Adjusted range to match the number of rows on the page
    data = {}
    ...
    # データの挿入
    sql_insert_data = '''
        INSERT INTO weather1 (day, hpa, temp_ave, temp_max, temp_min, humidity_ave, humidity_min, sun)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?);
    '''
